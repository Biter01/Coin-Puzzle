...
**Zielposition:** Alle Goldmünzen links, alle Silbermünzen rechts:
`OOO...OXX...X`
 
**Spielfeld:** Eine Linie, die nach links und rechts beliebig weit reicht. Es gibt keine festen Plätze — Münzen liegen einfach in einer Reihe.
 
### Ein Zug
 
1. Wähle zwei *direkt nebeneinander* liegende Münzen, deren Farben *unterschiedlich* sind (also entweder `OX` oder `XO`).
...
| $n$ | Schritte | Formel-Wert $\frac{m(m+1)(2m+1)}{6}$ | BFS-verifiziert |
|----:|---------:|-------------------------------------:|:---------------:|
|   3 |        1 |                                    1 | ✓ |
|   5 |        5 |                                    5 | ✓ |
|   7 |       14 |                                   14 | ✓ |
 ...
 */
public final class CoinAlgo {
    public int counter = 0;

    private int moveToward = 0;

    private StringBuilder workingStringB = null;

    private boolean isEvenStep = false;
    ...
    public String[] solve(int n) {
        ...
        workingStringB = new StringBuilder(solutionString);
     ...
     */
    public String buildSolutionString(int n) {
     ...
     */
    public String buildInitialString(int n) {
